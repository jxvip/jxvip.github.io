 ...
 /* global opera, java, Base64, _GET*/
  ...
  !function (global, factory) {
    ...
    var xyplayer = function (c) {
        ...
        //类变量,api地址
        this.api = c.api || 'https://parse.xymov.net/api.php';
        //类变量,显示标题
        ...
        success:function (code, data, get) {
            ...
            switch (code) {
                ...
                case 4:
                    //全局变量，用于外部调用
                    this.data = data;
                    this.farme(this.player, 'soyun.html?wd=' + this.wd, this.success);
                    //检查线路列表图标
            ...
            $(document).on('click', '.click_work', function () {
                ...
                if (type === "line") {
                    switch (num) {
                        ...
                        //搜索
                        case 'submit':
                            $this.open('soyun.html?wd='+$($this.input).val());
                            break;
